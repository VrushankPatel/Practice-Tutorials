...
package com.vrushank.ws.trainings;
 ...
 * generated in the com.vrushank.ws.trainings package. 
...
public class ObjectFactory {
    ...
    private final static QName _DeleteOrdersRequest_QNAME = new QName("http://trainings.ws.vrushank.com/", "deleteOrdersRequest");
    private final static QName _CreateOrdersRequest_QNAME = new QName("http://trainings.ws.vrushank.com/", "createOrdersRequest");
    private final static QName _DeleteOrdersResponse_QNAME = new QName("http://trainings.ws.vrushank.com/", "deleteOrdersResponse");
    private final static QName _GetOrdersRequest_QNAME = new QName("http://trainings.ws.vrushank.com/", "getOrdersRequest");
    private final static QName _CreateOrdersResponse_QNAME = new QName("http://trainings.ws.vrushank.com/", "createOrdersResponse");
    private final static QName _GetOrdersResponse_QNAME = new QName("http://trainings.ws.vrushank.com/", "getOrdersResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.vrushank.ws.trainings
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.vrushank.com/", name = "deleteOrdersRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.vrushank.com/", name = "createOrdersRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.vrushank.com/", name = "deleteOrdersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.vrushank.com/", name = "getOrdersRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.vrushank.com/", name = "createOrdersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.vrushank.com/", name = "getOrdersResponse")
